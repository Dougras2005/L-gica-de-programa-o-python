...
while True:
    voto = int(input('Digite  o seu voto (1,2 e 3 - para candidatos , 0 para branco e 4 para nulo: )'))
...
if cont1 > cont2 and cont2 >cont3:
    print(f'O candidato 1 é o vemcedor com {cont1} votos.')
elif cont2 > cont1 and cont1 >cont3:
    print(f'O candidato 1 é o vemcedor com {cont2} votos.')
else:
    print(f'O candidato 1 é o vemcedor com {cont3} votos.')
